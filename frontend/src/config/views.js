export const SYSTEM_VIEWS = [
    ...
    { id: 'payment_receipts_search', label: 'Buscar recibos', path: '/admin/receipts/search', menuLabel: 'Buscar Recibos', section: 'crm', scope: 'company' },
...
export const DEFAULT_ROLE_VIEW_ACCESS = {
    ...
    admin: [
        ...
        'leads_board', 'appointments_calendar', 'deleted_leads', 'ally_board', 'alerts', 'sales', 'goals', 'payment_receipts_search', 'payment_receipts', 'credits', 'public_credit_submissions', 'purchase_board',
        'gmail_credit_audit',
