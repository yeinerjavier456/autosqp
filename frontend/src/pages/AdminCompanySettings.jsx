        ...
        if (id) {
            ...
            const fetchCompany = async () => {
                try {
                    ...
                    const response = await axios.get(`http://localhost:8001/companies/${id}`, {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (isEditing) {
                ...
                await axios.put(`http://localhost:8001/companies/${id}`, company, { headers });
                setStatus({ type: 'success', message: `Empresa "${company.name}" actualizada exitosamente!` });
            } else {
                const response = await axios.post('http://localhost:8001/companies/', company, { headers });
