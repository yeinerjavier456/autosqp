...
const WhatsAppDashboard = () => {
    ...
    const fetchConversations = async () => {
        try {
            ...
            const response = await axios.get('http://localhost:8001/whatsapp/conversations', {
    ...
    const fetchMessages = async (conversationId) => {
        try {
            const token = localStorage.getItem('token');
            const response = await axios.get(`http://localhost:8001/whatsapp/conversations/${conversationId}/messages`, {
                headers: { Authorization: `Bearer ${token}` }
            });
    ...
    const handleSendMessage = async (e) => {
        ...
        try {
            ...
            await axios.post(`http://localhost:8001/whatsapp/conversations/${selectedConversation.id}/send`, payload, {
                headers: { Authorization: `Bearer ${token}` }
            });
