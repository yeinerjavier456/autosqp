...
export const DEFAULT_ROLE_VIEW_ACCESS = {
    ...
    admin: [
        ...
        'leads_board', 'appointments_calendar', 'deleted_leads', 'ally_board', 'alerts', 'sales', 'payment_receipts_search', 'payment_receipts', 'credits', 'public_credit_submissions', 'purchase_board',
        'gmail_credit_audit',
