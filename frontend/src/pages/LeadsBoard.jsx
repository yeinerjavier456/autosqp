...
const LeadCard = ({ lead, status, onDragStart, onViewHistory, isHighlighted = false, boardMode = 'general' }) => {
    ...
    return (
        ...
        >
            ...
            <h4 className="font-bold text-slate-800 text-lg mb-2 leading-tight">{lead.name}</h4>
            ...
            <div className="flex items-center justify-between border-t border-slate-100 pt-3 mt-auto">
                <div className="min-w-0 flex items-center gap-2 text-xs text-slate-500">
                    <div className="w-6 h-6 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-700 font-bold border border-indigo-200 text-[10px]">
                        {assignedPersonInitial}
                    </div>
                    <div className="min-w-0">
                        <p className="text-[10px] font-bold uppercase tracking-wide text-slate-400">Asignado a</p>
                        <p className="truncate text-xs font-semibold text-slate-600">{assignedPersonName}</p>
                    </div>
                </div>
