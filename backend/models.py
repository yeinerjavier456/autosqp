...
class Company(Base):
    ...
    crm_header_color = Column(String(50), nullable=True)
    crm_header_text_color = Column(String(50), nullable=True)
    crm_sidebar_color = Column(String(50), nullable=True)
    crm_sidebar_text_color = Column(String(50), nullable=True)
    crm_body_color = Column(String(50), nullable=True)
    crm_body_text_color = Column(String(50), nullable=True)
    public_header_color = Column(String(50), nullable=True)
    public_header_text_color = Column(String(50), nullable=True)
    public_body_color = Column(String(50), nullable=True)
    public_body_text_color = Column(String(50), nullable=True)
    ...
    public_credit_requires_email_validation = Column(Boolean, default=True)
...
class Role(Base):
    ...
    advisor_tracking_enabled = Column(Boolean, default=False)
...
class User(Base):
    ...
    ecard_headline = Column(String(180), nullable=True)
    ecard_headline_highlight = Column(String(80), nullable=True)
    ecard_subheadline = Column(String(250), nullable=True)
    ecard_visit_title = Column(String(160), nullable=True)
    ecard_visit_text = Column(String(250), nullable=True)
    ecard_footer_label_1 = Column(String(80), nullable=True)
    ecard_footer_label_2 = Column(String(80), nullable=True)
    ecard_footer_label_3 = Column(String(80), nullable=True)
    ecard_show_instagram = Column(Boolean, default=False, nullable=False)
    ecard_instagram_url = Column(String(500), nullable=True)
    ecard_show_facebook = Column(Boolean, default=False, nullable=False)
    ecard_facebook_url = Column(String(500), nullable=True)
    ecard_show_tiktok = Column(Boolean, default=False, nullable=False)
    ecard_tiktok_url = Column(String(500), nullable=True)
    ecard_show_whatsapp = Column(Boolean, default=True, nullable=False)
    ecard_whatsapp_url = Column(String(500), nullable=True)
...
class Sale(Base):
    ...
    purchase_manager_id = Column(Integer, ForeignKey("users.id"), nullable=True)
    credit_manager_id = Column(Integer, ForeignKey("users.id"), nullable=True)
    company_id = Column(Integer, ForeignKey("companies.id"))
    ...
    purchase_manager = relationship("User", foreign_keys=[purchase_manager_id])
    credit_manager = relationship("User", foreign_keys=[credit_manager_id])
    company = relationship("Company")
