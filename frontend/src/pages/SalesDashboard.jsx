...
const SalesDashboard = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Fetch Stats
            const statsRes = await axios.get('http://localhost:8001/finance/stats', { headers });
            setStats(statsRes.data);

            // Fetch Sales List
            const salesRes = await axios.get(`http://localhost:8001/sales/?status=${filterStatus}`, { headers });
    ...
    const handleApprove = async (saleId) => {
        ...
        try {
            const token = localStorage.getItem('token');
            await axios.put(`http://localhost:8001/sales/${saleId}/approve`, {}, {
