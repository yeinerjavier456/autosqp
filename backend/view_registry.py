SYSTEM_VIEWS = [
    ...
    {"id": "payment_receipts_search", "label": "Buscar recibos", "path": "/admin/receipts/search", "scope": "company"},
...
DEFAULT_ROLE_VIEW_ACCESS = {
    ...
    "admin": [
        ...
        "leads_board", "appointments_calendar", "deleted_leads", "ally_board", "alerts", "sales", "goals", "payment_receipts_search", "payment_receipts", "credits", "public_credit_submissions", "gmail_credit_audit", "purchase_board",
